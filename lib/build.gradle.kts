...
val projectArtifactId = "lib-common"
val projectRepoName = "lib-airfoil-common"
...
dependencies {
    listOf(
        Dependencies.Apache.Commons.Text,
        Dependencies.Apache.Commons.Validator,
        Dependencies.Auth0.JavaJwt,
        Dependencies.Exposed.Core,
        Dependencies.Exposed.Dao,
        Dependencies.Google.LibPhoneNumber,
        ...
        Dependencies.Ktor.Server.Config.Yaml,
